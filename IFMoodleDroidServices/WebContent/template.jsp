...
<body id="page-top" class="index">
	...
	<div class="container">
		...
		<div class="navbar-header page-scroll">
			...
			<a class="navbar-brand page-scroll" href="#page-top">Moodle
				Services</a>
		</div>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a class="page-scroll" href="#portfolio">WebServices</a></li>
	...
	<div class="container">
		<div class="intro-text">
			<div class="intro-lead-in">Welcome To Moodle Services!</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				...
				<h3 class="section-subheading text-muted">The main objective of
					this work is to develop a webservice the Moodle learning platform.
					The project is allocated at the Federal Institute of Education,
					Science and Technology of Pernambuco, Recife Campus.</h3>
			</div>
		</div>
		<div class="row text-center">
			<div class="col-md-4">
				...
				<p class="text-muted">We created the following services to
					students: news, check courses, look for people by name, my
					contacts, add a contact, delete a contact, block a contact and
					unblock a contact.</p>
			</div>
			<div class="col-md-4">
				<span class="fa-stack fa-4x"> <i
				...
				<h4 class="service-heading">Foruns</h4>
				<p class="text-muted">We created the following services to the
					forums: forums list a course, list topics of a forum, list posts a
					topic and list of forums week.</p>
			</div>
			<div class="col-md-4">
				<span class="fa-stack fa-4x"> <i
					class="fa fa-circle fa-stack-2x text-primary"></i> <i
				...
				<h4 class="service-heading">Message</h4>
				<p class="text-muted">We created the following services for the
					messages: messages sent/unread, messages sent/read and send a
					message</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 text-center">
				<h2 class="section-heading">WebServices</h2>
				<h3 class="section-subheading text-muted">Below is the created
					services</h3>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4 col-sm-6 portfolio-item">
				...
				<div class="portfolio-caption">
					<h4>Courses</h4>
					<p class="text-muted">Check courses from user</p>
				</div>
			</div>
			<div class="col-md-4 col-sm-6 portfolio-item">
						...
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<p class="item-intro text-muted">Deve ser informado os
									...
									<div class="form-group">
										<form class="form-inline" method="post" action="http://localhost:8080/IFMoodleDroidServices/rest/listener/verificarCursos">
											<div>
