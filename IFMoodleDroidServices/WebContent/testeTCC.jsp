...
<body>
	<h1 class="text-center">Seja Bem Vindo ao Services do Moodle
		Droid!</h1>
	...
	<form method="post"
		...
		<input type="text" name="flagDecriptacao" title="aaaa" /> <br /> <input
	...
	<form method="post"
		...
		<p>Id_curso:</p>
		<input type="text" name="cursoId" /><br /> <input type="submit"
			value="Enviar" />
	</form>
	<hr>
	...
	<form method="post"
		...
		<input type="text" name="flagDecriptacao" title="aaaa" /> <br />
		<p>forumId:</p>
		<input type="text" name="forumId" /><br /> <input type="submit"
			value="Enviar" />
	</form>
	<hr>
	...
	<form method="post"
		...
		<input type="text" name="flagDecriptacao" title="aaaa" /> <br />
		<p>Id_topico:</p>
		<input type="text" name="topicoId" /><br /> <input type="submit"
			value="Enviar" />
	</form>
	...
	<form method="post"
		...
		<input type="text" name="senha" /><br />
		<p>flag de decriptação(0 - off, 1 - on):</p>
		<input type="text" name="flagDecriptacao" title="aaaa" />
		<p>Id:</p>
		<input type="text" name="id" /><br />
		<p>Mensagem:</p>
		<input type="text" name="message" /><br />
		<p>Id do contato:</p>
		<input type="text" name="userIdTo" /><br /> <br /> <input
			type="submit" value="Enviar" />
	</form>
	<br>
	<hr>
	...
	<form method="post"
		...
		<input type="text" name="flagDecriptacao" title="aaaa" />
		<p>Id_contato:</p>
		<input type="text" name="contatoId" /><br />
		<p>flag Bloqueio Ou Desbloqueio(0 - desblq, 1 - bloq):</p>
		<input type="text" name="flagBloqueioOuDesbloqueio" /><br /> <br />
	...
	<form method="post"
		...
		<p>Id_contato:</p>
		<input type="text" name="contatoId" /><br />
		<p>Desbloqueio(Digite 0):</p>
		<input type="text" name="flagDesbloqueio" /><br /> <br /> <input
			type="submit" value="Enviar" />
	</form>
	<hr>
	...
	<form method="post"
		...
		<input type="text" name="flagDecriptacao" title="aaaa" />
		<p>Id_contato:</p>
		<input type="text" name="contatoId" /><br /> <br /> <input
			type="submit" value="Enviar" />
	</form>
	<hr>
	...
	<form method="post"
		...
		<input type="text" name="flagDecriptacao" title="aaaa" />
		<p>Id curso:</p>
		<input type="text" name="idCurso" /><br /> <br /> <input
			type="submit" value="Enviar" />
	</form>
	<hr>
	<p>buscar links:</p>
	<form method="post"
		...
		<input type="text" name="flagDecriptacao" title="aaaa" />
		<p>Id Section:</p>
		<input type="text" name="idSection" /><br /> <br /> <input
			type="submit" value="Enviar" />
	</form>
	<hr>
	...
	<form method="post"
		...
		<input type="text" name="flagDecriptacao" title="aaaa" /> <br />
		<p>ID Semana:</p>
		<input type="text" name="semanaId" /><br /> <input type="submit"
			value="Enviar" />
	</form>
	<hr>
